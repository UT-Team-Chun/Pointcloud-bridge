...
from utils.dataset_ybc import Dataset_ybc
...
def train():
    ...
    #重要！！！！
    #橋部材点群データの各クラスのサンプル数に応じて、損失関数の重みを設定する
    #クラスの重みが自動計算
    #クラスが多いほど、そのクラスの重みが小さくなる
    ...
    for epoch in range(1, config['num_epochs']+1):
        ...
        confusion_matrix = torch.zeros(num_classes, num_classes).to(device)  # 混同行列
