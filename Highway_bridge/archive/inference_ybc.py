...
def main():
    ...
    exp_dir= 'experiments/OK_miou90_exp_122920_brimulti_brienc_CB_all_weightedloss'
    ...
    from experiments.OK_miou90_exp_122920_brimulti_brienc_CB_all_weightedloss.utils.BriPCDMulti import BriPCDMulti
    from experiments.OK_miou90_exp_122920_brimulti_brienc_CB_all_weightedloss.models.model import EnhancedPointNet2
    from torch.utils.data import DataLoader

    test_dataset = BriPCDMulti(
        data_dir='../data/YBC/val/',
...
def test():
    ...
    # from models.enhanced_pointnet2 import EnhancedPointNet2
    # 加载模型
    from experiments.OK_miou90_exp_122920_brimulti_brienc_CB_all_weightedloss.models.enhanced_pointnet2 import EnhancedPointNet2
    model = EnhancedPointNet2(num_classes)
    checkpoint_path = 'experiments/OK_miou90_exp_122920_brimulti_brienc_CB_all_weightedloss/latest_checkpoint.pth'
