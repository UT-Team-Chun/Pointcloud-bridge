...
def main():
    ...
    config = {
        ...
        'exp_dir' : 'experiments/YBC/exp_051419_PTV3_YBC_Bridge',
    ...
    class_names = ['Background', 'U_Flg', 'Web', 'B_Flg', 'Vert_Stiff', 'Vert_Stiff_other','Horz_Stiff', 'Horz_Stiff_other']
    ...
    model=PointTransformerV3(config['num_classes'], d_in=in_channels,embed_dim=384, # 嵌入维度
                                    depth=8,  # 深度
                                    num_heads=2, # 多头注意力机制
