...
class EnhancedPointNet2(nn.Module):
    def __init__(self, num_classes=8):
        ...
        # Decoder
        self.fp3 = FeaturePropagation(1536, [512, 256, 256])  # multi: 512*2 + 256*2 ,1536 ; 256 + 256*2 ,768
        self.fp2 = FeaturePropagation(512, [256, 128, 128])  # multi:  256 + 128*2 ,768; 128 + 128*2 ,384
