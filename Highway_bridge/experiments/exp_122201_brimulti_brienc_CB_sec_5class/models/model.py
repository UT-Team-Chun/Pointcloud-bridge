...
from .attention_modules import BoundaryAwareModule, EnhancedAttentionModule, \
    GeometricFeatureExtraction, EnhancedPositionalEncoding, BridgeStructureEncoding, ConsistentPositionEncoding
...
class EnhancedPointNet2(nn.Module):
    def __init__(self, num_classes=8):
        ...
        self.bri_enc = BridgeStructureEncoding(input_ch, 128, 4)
        self.con_enc = ConsistentPositionEncoding(input_ch, 6, 0.001)
    ...
    def forward(self, xyz, colors):
        ...
        pos_enc = self.con_enc(xyz) # [B, 64, N]
        # Change the order of dimensions
