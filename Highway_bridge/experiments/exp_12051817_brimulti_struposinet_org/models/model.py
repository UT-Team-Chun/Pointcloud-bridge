...
class EnhancedPointNet2(nn.Module):
    def __init__(self, num_classes=8):
        ...
        self.sa2 = MultiScaleSetAbstraction(256,[0.2, 0.4],[16, 32], 259,[128, 256, 256])
        self.sa3 = MultiScaleSetAbstraction(64,[0.4, 0.8],[16, 32], 515,[256, 512, 512])
        ...
        # Decoder
        self.fp3 = FeaturePropagation(1536, [512, 384, 256])  # multi: 512*2 + 256*2 ,1536 ; 256 + 256*2 ,768
        self.fp2 = FeaturePropagation(512, [256, 256, 128])  # multi:  256 + 128*2 ,768; 128 + 128*2 ,384
