...
class EnhancedPointNet2(nn.Module):
    def __init__(self, num_classes=8):
        ...
        self.fp1 = EnhancedFeaturePropagation(128, [128, 64]) # multi:  128*2 ,256

        # self.fp4 = EnhancedPointTransformerDecoder(2048, [1024, 512]) # multi: 1024*2 + 512*2 ,3072; 512 + 512*2 ,1536
        # self.fp3 = EnhancedPointTransformerDecoder(1024, [512, 256])  # multi: 512*2 + 256*2 ,1536
        # self.fp2 = EnhancedPointTransformerDecoder(512, [256, 128])  # multi:  256*2 ,512
        # self.fp1 = EnhancedPointTransformerDecoder(128, [128, 64])
        ...
        self.final_fusion = nn.Sequential(
            nn.Conv1d(960, 512, 1), #128+256+256; #64+128+256+512=960
            nn.BatchNorm1d(512),
            nn.ReLU(),
            nn.Conv1d(512, 128, 1),
            nn.BatchNorm1d(128),
        ...
        #
        # Final layers
        self.final_fusion_0 = nn.Sequential(
            nn.Conv1d(128, 128, 1),
            nn.BatchNorm1d(128),
            nn.Dropout(0.1),
            nn.Conv1d(128, num_classes, 1)
