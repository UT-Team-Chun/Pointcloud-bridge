...
class EnhancedPointNet2(nn.Module):
    def __init__(self, num_classes=8):
        ...
        self.sa3 = MultiScaleSetAbstraction(256,[0.4, 0.8],[16, 32], 515,[256, 512, 1024])
        #self.sa4 = MultiScaleSetAbstraction(128,[0.8, 1.6],[16, 32], 1027,[512, 1024, 2048])
        ...
        self.fp3 = FeaturePropagation(2560, [1024, 512])  # multi: 512*2 + 256*2 ,1536 ; 256 + 256*2 ,768
        self.fp2 = FeaturePropagation(768, [512, 512])  # multi:  256 + 128*2 ,768; 128 + 128*2 ,384
        self.fp1 = FeaturePropagation(512, [256, 256]) # multi:  128 + 64 128, 384; 128 + 64 128
