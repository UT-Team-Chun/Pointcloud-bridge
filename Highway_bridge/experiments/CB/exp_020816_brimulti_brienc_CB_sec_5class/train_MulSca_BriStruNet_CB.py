...
def train():
    ...
    case = 'brimulti_brienc_CB_sec_5class'
    ...
    # 构建到data文件夹的路径
    train_dir = os.path.join(os.path.dirname(current_dir), 'data/CB/all/train/')
    val_dir = os.path.join(os.path.dirname(current_dir), 'data/CB/all/val/')
