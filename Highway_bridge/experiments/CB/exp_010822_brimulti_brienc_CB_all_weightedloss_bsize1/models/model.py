...
class EnhancedPointNet2(nn.Module):
    def __init__(self, num_classes=8):
        ...
        self.tf1=TransformerFusion(960, 3)
    ...
    def forward(self, xyz, colors):
        ...
        # Learnable weights
        w0 = nn.Parameter(torch.tensor(1.0))
        w1 = nn.Parameter(torch.tensor(1.0))
        w2 = nn.Parameter(torch.tensor(1.0))
        w3 = nn.Parameter(torch.tensor(1.0))
        ...
        # Transformer fusion
        #multi_scale_features = self.tf1(multi_scale_features)
