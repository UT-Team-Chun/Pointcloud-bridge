...
class TransformerFusion(nn.Module):
    def __init__(self, in_channels, num_layers=2):
        ...
        self.positional_encoding = nn.Parameter(torch.randn(1, in_channels, 1))  # Learnable positional encoding
        encoder_layer = TransformerEncoderLayer(d_model=in_channels, nhead=8)
