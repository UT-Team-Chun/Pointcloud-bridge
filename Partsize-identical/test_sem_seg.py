import argparse
import os
from data_prep.BridgeDataLoader import ScannetDatasetWholeScene
import torch
import logging
...
class2label = {cls: i for i, cls in
               enumerate(classes)}  # {'abutment': 0, 'girder': 1, 'deck': 2, 'parapet': 3, 'noise': 4}
seg_classes = class2label
...
trained_result = '2024-10-05_01-43'
...
def main(args):
    ...
    root = 'D:\\Work\\Pointcloud-WL\\Pointcloud-bridge\\data\\bridge-5cls-fukushima'
